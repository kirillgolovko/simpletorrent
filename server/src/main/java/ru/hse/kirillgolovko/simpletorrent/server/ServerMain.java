...
import ru.hse.kirillgolovko.simpletorrent.server.appparams.AppParams;
import ru.hse.kirillgolovko.simpletorrent.server.socketprocessor.SocketProcessorThread;
...
public class ServerMain {
    ...
    public static  void main(String[] args){
        ...
        // проверяем наличие общей папки
        if(! new File(params().getSharedDirPath()).exists()){
            System.err.println("No such shared dir");
            System.exit(0);
        }
        ...
        try {
            ...
            System.out.println("Server is up on port = " + server.getLocalPort());
